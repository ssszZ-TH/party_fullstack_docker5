...
export default function OrganizationUserProfile() {
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "background.default" }}>
      <AppBarCustom title="Organization User Profile" />
      <Container maxWidth="md" sx={{ py: 4 }}>
        <Paper elevation={3} sx={{ p: 4, borderRadius: "shape.borderRadius", bgcolor: "background.paper" }}>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" sx={{ color: "text.primary" }}>
              <strong>Federal Tax ID:</strong> {profile.federal_tax_id || "N/A"}
            </Typography>
            <Typography variant="body1" sx={{ color: "text.primary" }}>
              <strong>Name (EN):</strong> {profile.name_en || "N/A"}
            </Typography>
            <Typography variant="body1" sx={{ color: "text.primary" }}>
              <strong>Name (TH):</strong> {profile.name_th || "N/A"}
            </Typography>
            <Typography variant="body1" sx={{ color: "text.primary" }}>
              <strong>Organization Type ID:</strong> {profile.organization_type_id || "N/A"}
            </Typography>
            <Typography variant="body1" sx={{ color: "text.primary" }}>
              <strong>Industry Type ID:</strong> {profile.industry_type_id || "N/A"}
            </Typography>
            <Typography variant="body1" sx={{ color: "text.primary" }}>
              <strong>Employee Count:</strong> {profile.employee_count || "N/A"}
            </Typography>
            <Typography variant="body1" sx={{ color: "text.primary" }}>
              <strong>Slogan:</strong> {profile.slogan || "N/A"}
            </Typography>
            <Typography variant="body1" sx={{ color: "text.primary" }}>
